...
while True:
    ...
    if len(fingers)!=0 and fingers[1] == 1 and fingers[2] == 1:
        ...
        if length < 40:
            ...
            autopy.mouse.click()
    # print(fingers)
    # 9. Air canvas condition
    if len(fingers)!=0 and fingers[0]==1 and fingers[3]==1 and fingers[1]==0 and fingers[2]==0:
        print("air canvas")
        air_canvas()
    # elif len(fingers)!=0 and fingers[0]==0 and fingers[1]==0 and fingers[2]==0 and fingers[3]==0:
